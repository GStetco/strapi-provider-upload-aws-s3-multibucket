    ...
    return {
      upload: (file) => {
        return new Promise((resolve, reject) => {
          ...
          if(fileType === "image") {
            S3 = new AWS.S3({apiVersion: '2006-03-01', params: { Bucket: config.imageBucket}});
            path = "img/";
          } 
          else if(fileType === "video") {
            S3 = new AWS.S3({apiVersion: '2006-03-01', params: { Bucket: config.videoBucket}});
          }else if(fileType === "audio") {
            S3 = new AWS.S3({apiVersion: '2006-03-01', params: { Bucket: config.audioBucket}});
          }else {
